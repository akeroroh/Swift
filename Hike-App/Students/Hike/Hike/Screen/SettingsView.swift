    ...
    var body: some View {
        List {
                        ...
                        ForEach(alternateAppIcons.indices, id: \.self) { item in
                            Button {
                                ...
                                UIApplication.shared.setAlternateIconName(alternateAppIcons[item]) {
                                    error in
                                    if error != nil {
                                        print("Failed request to ujpdate the app's icon: \(String(describing: error?.localizedDescription))")
                                    } else {
            ...
            Section (
                ...
                CustomListRowView(rowLabel: "Technologh", rowIcon: "swift", rowContent: "Swift", rowTintColor: .orange)
